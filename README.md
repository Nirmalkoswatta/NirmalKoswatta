...
I am a **DevOps Engineer and Final Year Computer Science student @ SLIIT**, focused on building reliable cloud infrastructure, automated delivery pipelines, and scalable cloud-native applications.

My core engineering interests are:

**☁️ Cloud → ⚙️ Automation → 🚀 CI/CD → 🐳 Containers → ☸️ Kubernetes → 📊 Observability**
...
Outside technology, I train **boxing 🥊**, which keeps me disciplined, focused, and consistent.
...
**AI-powered vehicle recognition, 3D customization, and budget optimization platform.**

**Tech Stack**

`React` `Three.js` `React Three Fiber` `WebXR` `FastAPI` `TensorFlow` `MongoDB` `Node.js` `JWT` `Stripe`

**Key Features**

* 🚗 AI-powered vehicle classification
* 🧠 MobileNetV2 transfer learning
* 🎨 Interactive 3D vehicle customization
* 🌐 WebXR-ready architecture
* 💰 Budget-aware modification planning
* 📍 Geospatial marketplace discovery
...
**Recommendation-driven accommodation platform for university students.**

**Tech Stack**

`Next.js` `React` `TypeScript` `Tailwind CSS` `MongoDB` `Mongoose` `Leaflet`
...
I continuously experiment with modern infrastructure technologies and build projects around:

<div align="center">

**Docker** → **Kubernetes** → **Terraform** → **GitHub Actions** → **Argo CD** → **Prometheus** → **Grafana**
...
<img src="https://raw.githubusercontent.com/NirmalKoswatta/NirmalKoswatta/output/github-contribution-grid-snake-dark.svg" alt="GitHub contribution snake animation" />
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=NirmalKoswatta&bg_color=0D1117&color=58A6FF&line=58A6FF&point=FFFFFF&area=true&hide_border=true" width="100%" alt="GitHub contribution graph" />
...
<img src="https://github-profile-trophy.vercel.app/?username=NirmalKoswatta&theme=algolia&no-frame=true&no-bg=true&margin-w=10&margin-h=10&row=2&column=4" width="90%" alt="GitHub trophies" />
