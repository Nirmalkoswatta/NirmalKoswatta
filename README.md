...
I work on deployment pipelines, containerized environments, and cloud infrastructure day-to-day at Zuse Technologies, and build full-stack + applied-AI side projects in my own time. Final-year BSc (Hons) Computer Science student at the University of Bedfordshire (expected 2027), with an HND in IT from SLIIT City University (2025).
...
GarageVR Final-year project — WebXR/WebGL 3D vehicle configurator with a computer-vision brand classifier (EfficientNetB3, ~24k images) and a geospatial parts marketplace on MongoDB Atlas.

WebXR Computer Vision MongoDB

</td> <td width="50%" valign="top">

Tea Lives Tea estate management system with a RAG-based AI assistant and a deep-learning disease classification model.

React Node.js RAG Deep Learning

</td> </tr> </table> <br/>
✅  Currently Building Toward
 Dockerized every side project — shipped across GarageVR & Tea Lives
 CI pipelines with GitHub Actions — used for automated builds/deploys at Zuse
 Terraform — working through infrastructure-as-code fundamentals
 Jenkins — building pipelines outside of GitHub Actions
 ELK Stack — log aggregation and monitoring
<br/> <img width="100%" src="https://capsule-render.vercel.app/api?type=rect&color=0:1B4B8F,100:0F1424&height=80"/>
